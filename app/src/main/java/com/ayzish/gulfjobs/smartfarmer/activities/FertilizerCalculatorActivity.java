...
//adds in the link when clicking the logo
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://blogs.lt.vt.edu/mastergardener/healthyvirginialawns/"));
        ...
        Button calc_N = (Button) findViewById(R.id.calc_N);
        Button calc_P = (Button) findViewById(R.id.calc_P);
        Button calc_K = (Button) findViewById(R.id.calc_K);



        //sets the edit texts to the right fields
        et_N_val = (EditText) findViewById(R.id.n_val);
        et_P_val = (EditText) findViewById(R.id.p_val);
        et_K_val = (EditText) findViewById(R.id.k_val);
        et_N_amt = (EditText) findViewById(R.id.n_amt);
        et_tot_area = (EditText) findViewById(R.id.area_num);
    ...
    private void makeCalculation_N() {
        ...
        String sp1, sp2;
        Spinner sp_spinner1 = (Spinner) findViewById(R.id.spinner1);
        Spinner sp_spinner2 = (Spinner) findViewById(R.id.spinner2);
        ...
        if(!(n_inp) & !(p_inp) & !(k_inp) & !(area_inp) & !(amt_inp) & !(err)) {
            ...
            result = "Fertilizer needed: " + df.format(T_result) + " pounds\n   " + "Total Nitrogen applied: " + df.format(N_result) + " pounds\n   This also applies:\n   " +
                    df.format(P_result) + " pounds of Phosphorus\n   " + df.format(K_result) + " pounds of potassium.";
        ...
        if(err){
            if(n_inp){
                EditText edText = (EditText) findViewById(R.id.n_val);
                edText.setHintTextColor(Color.RED);
            }
            if(p_inp){
                EditText edText = (EditText) findViewById(R.id.p_val);
                edText.setHintTextColor(Color.RED);
            }
            if(k_inp){
                EditText edText = (EditText) findViewById(R.id.k_val);
                edText.setHintTextColor(Color.RED);
            }
            if(area_inp){
                EditText edText = (EditText) findViewById(R.id.area_num);
                edText.setHintTextColor(Color.RED);
            }
            if(amt_inp){
                EditText edText = (EditText) findViewById(R.id.n_amt);
                edText.setHintTextColor(Color.RED);
            }
            Toast.makeText(FertilizerCalculatorActivity.this,
    ...
    private void makeCalculation_P(){
        ...
        if(!(n_inp) & !(p_inp) & !(k_inp) & !(area_inp) & !(amt_inp) & !(err)) {
            ...
            result = "Fertilizer needed: " + df.format(T_result) + " pounds\n   " + "Total Phosphorus applied: " + df.format(P_result) + " pounds\n   This also applies:\n   " +
                    df.format(N_result) + " pounds of Nitrogen\n   " + df.format(K_result) + " pounds of potassium.";
            tv_result.setMovementMethod(ScrollingMovementMethod.getInstance());
            tv_result.setText(result);
        }else err = true;
        if(err){
    ...
    private void makeCalculation_K() {
        ...
        if (!(n_inp) & !(p_inp) & !(k_inp) & !(area_inp) & !(amt_inp) & !(err)) {
            ...
            result = "Fertilizer needed: " + df.format(T_result) + " pounds\n   " + "Total Potassium applied: " + df.format(K_result) + " pounds\n   This also applies:\n   " +
                    df.format(P_result) + " pounds of Phosphorus\n   " + df.format(N_result) + " pounds of Nitrogen.";
